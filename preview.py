...
class Ui_ConfigElement(object):
    def setupUi(self, ConfigElement):
        ...
        self.textLayoutLeft.setContentsMargins(-1, 10, 10, -1)
        ...
        self.textLayoutLeft.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.materialNC_2)
        ...
        self.textLayoutLeft.setVerticalSpacing(10)
